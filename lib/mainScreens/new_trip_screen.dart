...
import 'package:application/widgets/fare_amount_collection_dialog.dart';
...
import 'package:application/assistants/black_theme_google_map.dart';
...
class _NewTripScreenState extends State<NewTripScreen>
{
  ...
  endTripNow() async
  {
    showDialog(
      ...
      //fare amount
      double totalFareAmount = AssistantMethods.calculateFareAmountFromOriginToDestination2(tripDirectionDetails!);
