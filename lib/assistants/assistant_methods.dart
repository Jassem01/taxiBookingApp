...
class AssistantMethods
{
  ...
  static double calculateFareAmountFromOriginToDestination2(DirectionDetailsInfo directionDetailsInfo)
  {
    double timeTraveledFareAmountPerMinute = (directionDetailsInfo.duration_value! / 60) * 0.1;
    double distanceTraveledFareAmountPerKilometer = (directionDetailsInfo.duration_value! / 1000) * 0.1;
    ...
    {
      double resultFareAmount = (totalFareAmount) / 2.0;
      return double.parse(resultFareAmount.toStringAsFixed(1));
    }
    else if(driverVehicleType == "F-uber-go")
    {
      return double.parse(totalFareAmount.toStringAsFixed(1));
    }
    else if(driverVehicleType == "F-uber-x")
    {
      double resultFareAmount = (totalFareAmount) * 2.0;
      return double.parse(resultFareAmount.toStringAsFixed(1));
    }
